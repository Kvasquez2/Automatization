...
public class AfiliadoHomonimoDocumento {
    ...
    @Test
    public void afiliHomonimoDocu() throws InterruptedException {
    ...
    private void seleccionarDatos() throws InterruptedException {
        ...
        String query = "SELECT mae_tipo_documento_id, numero_documento, primer_nombre, segundo_nombre, primer_apellido, segundo_apellido " +
                "FROM aseg_afiliados WHERE mae_tipo_documento_id NOT IN (409, 406, 413) ORDER BY RAND() LIMIT 1";
        ...
        try (Statement stmt = conexion.createStatement();
            ...
            if (rs.next()) {
                ...
                driver.findElement(By.cssSelector("input#frmCrear\\:primerApellido")).sendKeys(primerApellido);
                esperar(300);
                driver.findElement(By.cssSelector("input#frmCrear\\:segundoApellido")).sendKeys(segundoApellido);
                esperar(300);
                driver.findElement(By.cssSelector("input#frmCrear\\:primerNombre")).sendKeys(primerNombre);
                esperar(300);
                driver.findElement(By.cssSelector("input#frmCrear\\:segundoNombre")).sendKeys(segundoNombre);
                esperar(300);
